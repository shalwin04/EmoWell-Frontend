...
const blogs = [
  {
    ...
    description:
      "Learn effective ways to cope with anxiety and stress in your daily life.",
  ...
  },
  {
    ...
    description:
      "Practice mindfulness to improve your mental well-being and reduce stress.",
  ...
  },
  {
    ...
    description:
      "Develop good sleep routines for better mental health and daily energy.",
  ...
  },
  {
    ...
    description:
      "Effective strategies to manage stress and maintain work-life balance.",
...
export default function BlogsScreen() {
  ...
  return (
    <View className="flex-1 bg-primary px-4 pt-4">
      <Text className="text-2xl font-bold text-gray-900 mb-4 mt-0">
        Latest Articles
      </Text>
